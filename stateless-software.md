...
If things go well, we may even see an entirely new class of software -- neither one-off code generations, nor deep infrastructure, but open applications on shared data stores that we all work together to build in the commons.
