...
Many people have tried to call the future of coding by saying that "software is dead", or that everyone will have personal software that they customize to their heart's content. I think where we actually land will be somewhere in the middle. Certain kinds of software probably won't be sustainable once code generation becomes easy, but not everyone will prompt their own application. But there may be a thriving class that exists between the two extremes, of people coming together to build applications on top of portable data and shared stores.